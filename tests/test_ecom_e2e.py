...
class Testone(Baseclass):
    ...
    expceted_adoptor_results = 'results for "apple adapter 20w"'
    expceted_adoptor_name = 'Apple 20W ,USB-C Power Charging Adapter for iPhone, iPad & AirPods  (White)'
    pincode = '500081'
    ...
    adoptor_result_page = base_path + 'adoptor_result_page' + str(DateString) + '.png'
    adoptor_window = base_path + 'adoptor_window' + str(DateString) + '.png'
    cart_after_adding_adopter = base_path + 'cart_after_adding_adopter' + str(DateString) + '.png'

    def test_flipkart_page(self):

        # driver = self.driver
        # Flipkart main page validation and product search
    ...
    def test_book(self):
        ...
        # Navigating to newly opened window and verifing the book name
        windows = self.driver.window_handles
    ...
    def test_adopter(self):
        ...
        self.driver.get_screenshot_as_file(self.adoptor_result_page)

        ar_page = AdopterResultsPage(self.driver)
        actual_adop_result_text = ar_page.adopter_text_in_results_page().text
        assert self.expceted_adoptor_results in actual_adop_result_text
        ...
        assert actual_adopter_name == self.expceted_adoptor_name
        ...
        time.sleep(3)
        self.driver.get_screenshot_as_file(self.adoptor_window)
    ...
    def test_price_validation(self):
        c_page = CartPage(self.driver)
        tot_price = c_page.price_of_items()
        print(tot_price)
